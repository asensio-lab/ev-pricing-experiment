...
EV_count <- as.data.frame(table(EV_recurring$userID))
EV_count_pre <- as.data.frame(table(EV_recurring_pre$userID))
EV_count_post <- as.data.frame(table(EV_recurring_post$userID))
